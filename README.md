...
- **Scarto per l’80%** (prima tabella): per ogni modello e ogni tipo di previsione (temperatura ora per ora, massima e minima del giorno, vento medio ora per ora, vento massimo del giorno, pioggia del giorno, oraria e a 3 ore in mm) lo scarto più piccolo entro cui cade l’80% delle previsioni: «±1,8 °C» = nell’80% dei casi ha sbagliato al massimo di 1,8 °C. Più basso è meglio. La percentuale è impostabile. La pioggia in mm si calcola solo con le stazioni meteo e solo sui periodi in cui è piovuto o era prevista pioggia. Sopra questa tabella ci sono le schede 3, 2 e 1 giorno prima.
